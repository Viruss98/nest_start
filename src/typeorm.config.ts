...
import { PCategory, PCategoryAccess } from './modules/pcategory/entities/pcategory.entity';
...
export const typeORMConfig: TypeOrmModuleOptions = {
  ...
  entities: [BlogEntity, User, Category, CategoryAccess, MediaEntity, AuthTokenEntity, PCategory, PCategoryAccess, ProductEntity],
